...
# python quarter_recog_train.py --training images/training --testing images/testing
...
for imagePath in paths.list_images(args["training"]):
    ...
    fd = hog(gray, orientations=8, pixels_per_cell=(8, 8), cells_per_block=(1, 1))
...
model = svm.SVC(gamma=0.0002, C=100)
...
filename = 'finalized_quarter_model.sav'
