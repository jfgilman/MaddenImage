...
# run this line in the ScreenID directory to trian
# python recogScreenIDTrain.py --training images/training --testing images/testing
...
filename = 'finalized_screenID_model.sav'
